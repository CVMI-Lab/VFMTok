...
<ins>We further extend the principle of building image tokenizers directly upon VFMs to the domains of continuous-valued image reconstruction and generation, achieving superior performance in both tasks. The source code has been made publicly available at [VFMTok2](https://github.com/CVMI-Lab/VFMTok2.git).</ins>
